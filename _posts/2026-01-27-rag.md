...
So I decided to build a RAG system over my own blog - a smarter, explain-as-you-go `Ctrl+F` for everything I've written.
...
**Result:** Chunk count dropped from **2851 to 1111**. Same 17 blog posts, but now each chunk actually has enough context for the embedding model to produce a meaningful vector. More importantly, retrieval quality jumped (numbers in Phase 5).
...
This step alone improved answer quality by filtering out irrelevant chunk types.
