...
## Building a RAG System for My Own Blog
...
*   *“Where did I explain this idea?”*
*   *“Can I get a short, grounded explanation instead of rereading the whole post?”*
...
- [Phase 1: Ingestion & Corpus Creation](#phase-1-ingestion--corpus-creation)
  - [1. Loading Blog Data](#1-loading-blog-data)
  - [2. Parsing Markdown](#2-parsing-markdown-harder-than-expected)
  - [3. Cleaning Without Summarizing](#3-cleaning-without-summarizing)
  - [4. Chunking](#4-chunking-the-most-important-step)
- [Phase 2: Embeddings & Vector Store](#phase-2-embeddings--vector-store)
  - [Embeddings](#embeddings)
  - [Vector Store (FAISS)](#vector-store-faiss)
- [Phase 3: Retrieval Control & Reranking](#phase-3-retrieval-control--reranking)
- [Phase 4: Prompting & Generation](#phase-4-prompting--generation)
  - [Prompt Construction](#prompt-construction)
  - [Generation (Local LLM)](#generation-local-llm)
  - [Citations & Grounding](#citations--grounding)
