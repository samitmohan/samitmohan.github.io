...
![YOLO Algorithm Overview](/assets/images/yolo/yoloAlgo.png){: loading="lazy"}
...
![CNN Visualization](/assets/images/yolo/cnn.png){: loading="lazy"}

*Figure: Convolutional Neural Network layers and how they extract features from images*

![CNN Feature Extraction](/assets/images/yolo/cnn2.png){: loading="lazy"}

*Figure: Detailed view of convolutional operations and feature map generation*

![Convolution Operation](/assets/images/yolo/conv.png){: loading="lazy"}
...
![Grid Cells and Center Points](/assets/images/yolo/grid_cell_and_center.png){: loading="lazy"}
...
![Object Centers](/assets/images/yolo/center.png){: loading="lazy"}

*Figure: Identifying which grid cell is responsible for each object based on center point location*

![Center Point Details](/assets/images/yolo/center_2.png){: loading="lazy"}
*Figure: Close-up view of how object center points determine grid cell responsibility*

![Center of Cell Calculation](/assets/images/yolo/center_of_cell.png){: loading="lazy"}
...
![Center Calculations](/assets/images/yolo/calculations_on_cneter.png){: loading="lazy"}
*Figure: Computing relative offsets (Δx, Δy) from grid cell top-left corner to object center*

![More on Center Encoding](/assets/images/yolo/more_on_center.png){: loading="lazy"}
*Figure: Detailed breakdown of how center coordinates are normalized relative to grid cell dimensions*

![XY Center Coordinates](/assets/images/yolo/x,ycenter.png){: loading="lazy"}
*Figure: Visualizing the x,y center point encoding process with actual coordinate values*

![Normalized Values](/assets/images/yolo/normalised_val_after_calc.png){: loading="lazy"}
...
![YOLO Target Format](/assets/images/yolo/yolo_targets.png){: loading="lazy"}
...
![Class Confidence Scores](/assets/images/yolo/class_conf.png){: loading="lazy"}
...
![Converting Coordinates](/assets/images/yolo/gt_coord.png){: loading="lazy"}
...
![Ground Truth Confidence](/assets/images/yolo/gt_conf.png){: loading="lazy"}
...
![IOU Visualization](/assets/images/yolo/iou.png){: loading="lazy"}
...
![Bounding Box Formats](/assets/images/yolo/x1,y1,x2,y2.png){: loading="lazy"}
...
![NMS Process](/assets/images/yolo/nms.png){: loading="lazy"}
...
![Loss Penalty Weighting](/assets/images/yolo/loss_penalty.png){: loading="lazy"}
...
![All Loss Components](/assets/images/yolo/all_losses.png){: loading="lazy"}
...
![Loss Again](/assets/images/yolo/loss_again.png){: loading="lazy"}
...
![Classification Loss](/assets/images/yolo/loss_class.png){: loading="lazy"}
...
![Complete Loss Function](/assets/images/yolo/entire_loss.png){: loading="lazy"}
*Figure: The complete YOLO loss function combining all three components with their respective weighting factors*

![Loss Equation Final](/assets/images/yolo/loss_eqn_final.png){: loading="lazy"}
*Figure: Mathematical formulation of the complete loss function with indicator functions and summations*

![All Losses Equation](/assets/images/yolo/all_losses_eqn.png){: loading="lazy"}
...
![Recap of Loss](/assets/images/yolo/loss_final.png){: loading="lazy"}
...
![YOLOv1 Results](/assets/images/yolo/results.png){: loading="lazy"}
*Figure: Performance comparison of YOLOv1 with other detection methods on Pascal VOC 2007 dataset*

![YOLOv1 Detailed Results](/assets/images/yolo/results2.png){: loading="lazy"}
