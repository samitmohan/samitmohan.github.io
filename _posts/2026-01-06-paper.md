...
categories: tech
tokens: "~4.6k"
description: "Taking DeepSeekV3 apart - MLA, MoE routing, multi-token prediction, and how I read a 53-page paper without losing my mind."
---
...
![results](/assets/images/paper/results.webp)

## Architecture



![arch](/assets/images/paper/arch.webp){: loading="lazy"}
...
<video autoplay loop muted playsinline style="max-width:100%" preload="none" poster="/assets/images/paper/mla_compression_poster.jpg">
...
- This is how attention scores look like for a normal MHA
  - ![attention_scores](/assets/images/paper/attention_mha.webp){: loading="lazy"}
    ...
    - So how does MLA solve this? Compress key-value pairs. How? *Low Rank Key-Value Joint Compression*
...
- ![cl](/assets/images/paper/commutative_law.webp){: loading="lazy"}
...
- ![drope](/assets/images/paper/decoupledROPE.webp){: loading="lazy"}

### Memory Requirements Summary

![comp](/assets/images/paper/comparision.webp){: loading="lazy"}
...
<video autoplay loop muted playsinline style="max-width:100%" preload="none" poster="/assets/images/paper/moe_routing_poster.jpg">
...
![dm](/assets/images/paper/ffn_dense.webp){: loading="lazy"}

**Q. What are sparse models?**
![sm](/assets/images/paper/sparse.webp){: loading="lazy"}
![sm2](/assets/images/paper/sm2.webp){: loading="lazy"}
...
![replace](/assets/images/paper/replaceFFN.webp){: loading="lazy"}
...
![moe](/assets/images/paper/moe.webp){: loading="lazy"}
...
![moe2](/assets/images/paper/moe2.webp){: loading="lazy"}
...
- DeepSeek v3 does Bias-Based Routing for DeepseekMoE
  - ![bias](/assets/images/paper/bias.webp){: loading="lazy"}
...
![formula](/assets/images/paper/formula.webp){: loading="lazy"}
...
![sparsity](/assets/images/paper/sparsity.webp){: loading="lazy"}

**Step 3: Normalize the selected experts (soft weighting)**
![normalise](/assets/images/paper/normalise.webp){: loading="lazy"}
> So they sum upto 1 (makes outputs stable, prevents exploding activations)

**Step 4: Apply routed experts**
![routed](/assets/images/paper/routed_exp.webp){: loading="lazy"}
...
- Advantages
  ...
  - ![loss](/assets/images/paper/loss_for_mtp.webp){: loading="lazy"}
