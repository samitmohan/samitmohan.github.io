...
- [Docker Bare Metals](https://btholt.github.io/complete-intro-to-containers/) + blog (deployment (docker, kubernetes, mlops(triton)))
- [Kubernetes](https://www.youtube.com/watch?v=KeCe5PmlPDA)
- [Git](https://www.youtube.com/watch?v=rH3zE7VlIMs) + git blog
...
- [Gaurav Sen System Design LLD + HLD](https://interviewready.io/) + DDIA + blog on these
- [ML Design Patterns](https://www.youtube.com/watch?v=DBfZ7hqgZFs&list=PLJf-Umv9fV2O3RyomJhiri_dRcrtgifvC&index=4) + blog
- Refine PostgreSQL (SQL) and Redis (cache), ORM (sqlalchemy), JWT, OAuth2, pytest, MLFLow, Airflow, Prometheus, Grafana
...
- HTTP Server scratch + FastAPI + [ShelfML](https://github.com/MarinaWyss/ShelfScanner)
...
- MiniTorch 
- Existing projects on website refine + deployable links
- Resnet blog
...
- Blog on quantisation, LORA, Vision vs CNN (yolo) for object detection on real time, word2vec
