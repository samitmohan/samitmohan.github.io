...
categories: goals
tokens: "~1.5k"
description: "Learning roadmap, resources, and 2026 goals for ML engineering, systems, and everything in between."
---

prsnl documentation; go away
...
- how modern LLMs work (sebastian; stanford)
- LLMOps and Inference Engineering: inference engineering + physics of LLMs + blog (llmops substack)
...
- ML Playlist + blogs accordingly
- Backend needed for ML (Vizuara) + Harkirat
- AI Engineering playlist
- LLD, HLD (gkcs) + OOP revise
- CS336, 244n, 329S
- [RL Course David Silver](https://www.youtube.com/playlist?list=PLqYmG7hTraZDM-OYHWgPebj2MfCFzFObQ)
...
- cracking interviews [ML](https://huyenchip.com/ml-interviews-book/) book
...
- [frontier](https://www.workatafrontierlab.com/courses) labs
- [system design](https://medium.com/@shivambhadani_/system-design-for-beginners-everything-you-need-in-one-article-c74eb702540b#cf4c)
