...
![LLMs Doesn't Recognise Spotify](/assets/images/mcp/llm-no-spotify.png){: loading="lazy"}
...
![How it Works](/assets/images/mcp/how-it-works.png){: loading="lazy"}
...
![MCP Tools in Claude](/assets/images/mcp/mcp-tools-claude.png){: loading="lazy"}

### In action

![Claude Talking to Spotify](/assets/images/mcp/claude-spotify-action.png){: loading="lazy"}

![Spotify2](/assets/images/mcp/spotify-2.png){: loading="lazy"}

![Spotify3](/assets/images/mcp/spotify-3.png){: loading="lazy"}
