...
Neural networks are behind pretty much everything interesting in AI right now: image recognition, language models, self-driving cars. Once you get the core ideas, everything else is just variations on the same theme.

This is a long one. Skip the math sections if you want, I won't judge.
