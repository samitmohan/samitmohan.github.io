...
![Perceptron](/assets/images/nn/perceptron.png)
...
![Neural Network](/assets/images/nn/nn.png){: loading="lazy"}
![Neural Network2](/assets/images/nn/neural-network-photo.png){: loading="lazy"}
...
![Image](/assets/images/nn/gradient-descent-graph.png){: loading="lazy"}
...
![Image2](/assets/images/nn/gradient-descent-formula.png){: loading="lazy"}
...
![Output2](/assets/images/nn/output-example-1.png){: loading="lazy"}

*This is what we want*

![Output](/assets/images/nn/output-example-2.png){: loading="lazy"}
...
![Plot](/assets/images/nn/loss-plot.png){: loading="lazy"}
#### The Derivative
...
![Bowl](/assets/images/nn/bowl.png){: loading="lazy"}
...
![Image3](/assets/images/nn/learning-rate.png){: loading="lazy"}
...
![Backpropagation Error Flow](/assets/images/nn/backprop-error-flow.png){: loading="lazy"}
...
![Backprop](/assets/images/nn/backprop.png){: loading="lazy"}
![Chain Rule](/assets/images/nn/chain-rule.png){: loading="lazy"}
...
![Simple NN](/assets/images/nn/simple-nn.png){: loading="lazy"}
...
![Image1](/assets/images/nn/math-derivation-1.png){: loading="lazy"}
![Image2](/assets/images/nn/math-derivation-2.png){: loading="lazy"}
![Image3](/assets/images/nn/math-derivation-3.png){: loading="lazy"}
...
![MNIST](/assets/images/nn/mnist-sample.png){: loading="lazy"}
...
![Output](/assets/images/nn/mnist-hotcoded.png){: loading="lazy"}
...
![9](/assets/images/nn/digit-9-prediction.png){: loading="lazy"}
...
![Output](/assets/images/nn/final-output.png){: loading="lazy"}
...
![CNN](/assets/images/nn/cnn.png){: loading="lazy"}
...
![AccuracyLoss](/assets/images/nn/accuracy-loss.png){: loading="lazy"}
