...
<video autoplay loop muted playsinline style="max-width:100%" preload="none" poster="/assets/images/math/chain_rule_poster.jpg">
...
Now we've seen how 1 neuron works.
How does it generalise to a "neural network"?
...
**the fix:**
Divide the learning rate by the magnitude of recent gradients. Big gradients get small effective LR. Small gradients get large effective LR. Playing field leveled.
...
<video autoplay loop muted playsinline style="max-width:100%" preload="none" poster="/assets/images/math/causal_mask_poster.jpg">
...
um do you really need a tutorial on how matrix multiplication works? Fine, quick refresher:
