...
tokens: "~15.2k"
math: true
description: "Every derivative, gradient, and matrix operation you need to understand deep learning - with code alongside every concept."
---
...
![neuron](/assets/images/math/neuron.webp)
...
![toy_example](/assets/images/math/toy_example.webp){: loading="lazy"}
...
![pd](/assets/images/math/pd.webp){: loading="lazy"}
...
<video autoplay loop muted playsinline style="max-width:100%" preload="auto">
...
![backprop_For_MSE](/assets/images/math/backprop_for_mse.webp){: loading="lazy"}
...
![toyexamplefinal](/assets/images/math/toy_example_final.webp){: loading="lazy"}
...
![plot_contour](/assets/images/math/plot_contour.webp){: loading="lazy"}
...
![derivative_sigmoid](/assets/images/math/derivative_sigmoid.webp){: loading="lazy"}
...
![nn](/assets/images/math/nn.webp){: loading="lazy"}
...
![example_for_comp](/assets/images/math/example_for_computation.webp){: loading="lazy"}
...
![nonlin](/assets/images/math/non_linearity.webp){: loading="lazy"}
...
![gd](/assets/images/math/gradients.webp){: loading="lazy"}
...
![loss_in_nn](/assets/images/math/loss_in_nn.webp){: loading="lazy"}
...
![backprop](/assets/images/math/backprop.webp){: loading="lazy"}

![update](/assets/images/math/updatation.webp){: loading="lazy"}
...
- Think of a ball rolling down but the ball is taking very small steps to go down when in fact we know if we can push it a little it can go down much faster initially and as it's close to the bottom of the bowl we can take small steps.
...
![sigmoid_prob](/assets/images/math/problem_with_sigmoid.webp){: loading="lazy"}
...
![softmax](/assets/images/math/softmax.webp){: loading="lazy"}
...
![problem_with_mse](/assets/images/math/smaxandmse.webp){: loading="lazy"}

Solution? **Cross Entropy Loss**

![ce](/assets/images/math/ce.webp){: loading="lazy"}


Not going to derive the partial derivative here, but you can do it in your free time. It'll be:


![derivaive_ce](/assets/images/math/derivative_ce.webp){: loading="lazy"}
...
![scale](/assets/images/math/scale.webp){: loading="lazy"}
...
![relu](/assets/images/math/relu.webp){: loading="lazy"}
...
![problem_with_Gd](/assets/images/math/problem_with_gd.webp){: loading="lazy"}
![sgdbad](/assets/images/math/SGD_BAD.webp){: loading="lazy"}
...
![adam](/assets/images/math/adam.webp){: loading="lazy"}
...
![lr](/assets/images/math/lr.webp){: loading="lazy"}

## Batch Normalisation

TLDR: it just speeds up + stabilises training using mean and variance, nothing fancy here.

Before batch norm, deep networks were a pain to train - gradients would vanish or explode during backprop. BN fixes this by normalizing the inputs to each layer so training doesn't blow up.
...
![res](/assets/images/math/resnet.webp){: loading="lazy"}
...
![resnet](/assets/images/math/resnet_transformers.webp){: loading="lazy"}
...
- All word embeddings of a document concatenated into a matrix (every row = embedding of different word)
  - What are word embeddings? Solves the problem of how to give text data to a Neural Network
    - What we want:
      ...
      - ![embeddings](/assets/images/math/embeddings.webp){: loading="lazy"}
...
![encoder-decoder](/assets/images/math/encoder-decoder.webp){: loading="lazy"}
...
![attention](/assets/images/math/attention.webp){: loading="lazy"}
![attention_formula](/assets/images/math/attention_for.webp){: loading="lazy"}

![howattnworks](/assets/images/math/how_attention_works.webp){: loading="lazy"}

#### Causal Masking

- If the sentence so far is "The quick brown fox", and the model is trying to predict the next word ("jumps"), it must only consider "The", "quick", "brown", and "fox". It can't see "jumps" or anything after it - those words haven't been generated yet. This is autoregressive generation.
...
![causal](/assets/images/math/causal.webp){: loading="lazy"}
...
![dot_prod](/assets/images/math/dot_product.webp){: loading="lazy"}
...
![mm](/assets/images/math/matrixmul.webp){: loading="lazy"}
