...
tokens: "~15.2k"
math: true
description: "All the math behind deep learning - calculus, linear algebra, activation functions, batch norm, resnets, and transformers."
---

> **TL;DR:** Every piece of math behind deep learning in one place: neurons, activation functions, the chain rule, gradient descent, batch normalization, resnets, attention, and transformers. Each concept comes with Python code showing how the math turns into implementation.

**what this covers:** all the math behind deep learning - neurons, activation functions, calculus for backprop, feed-forward networks, batch norm, resnets, and transformers. code alongside every concept so you see how the math turns into implementation.

This consists of all theory needed for AI. There are code sections with comments in them to help you understand how the math is implemented in practice.
...
![toy_example](/assets/images/math/toy_example.png){: loading="lazy"}
...
![pd](/assets/images/math/pd.png){: loading="lazy"}
...
<video autoplay loop muted playsinline style="max-width:100%">
  <source src="/assets/images/math/chain_rule.mp4" type="video/mp4">
</video>
...
![backprop_For_MSE](/assets/images/math/backprop_for_mse.png){: loading="lazy"}
...
![toyexamplefinal](/assets/images/math/toy_example_final.png){: loading="lazy"}
...
![plot_contour](/assets/images/math/plot_contour.png){: loading="lazy"}
...
![derivative_sigmoid](/assets/images/math/derivative_sigmoid.png){: loading="lazy"}
...
![nn](/assets/images/math/nn.png){: loading="lazy"}
...
![example_for_comp](/assets/images/math/example_for_computation.png){: loading="lazy"}
...
![nonlin](/assets/images/math/non_linearity.png){: loading="lazy"}
...
![gd](/assets/images/math/gradients.png){: loading="lazy"}
...
![loss_in_nn](/assets/images/math/loss_in_nn.png){: loading="lazy"}
...
![backprop](/assets/images/math/backprop.png){: loading="lazy"}

![update](/assets/images/math/updatation.png){: loading="lazy"}
...
- Oscillation: In narrow valleys, SGD bounces back and forth between steep walls, wasting computation.
- Slow Progress: Along flat directions, gradients are tiny. SGD crawls, never building up speed.
- Think of a ball rolling down but the ball is taking very small steps to go down when infact we know if we can push it a little it can go down much faster initially and as it's close to the bottom of the bowl we can take small steps.
...
![sigmoid_prob](/assets/images/math/problem_with_sigmoid.png){: loading="lazy"}
...
![softmax](/assets/images/math/softmax.png){: loading="lazy"}
...
![problem_with_mse](/assets/images/math/smaxandmse.png){: loading="lazy"}

Solution? **Cross Entropy Loss**

![ce](/assets/images/math/ce.png){: loading="lazy"}


Not going to derive the partial derivative here, but you can do it in your free time. It'll be:


![derivaive_ce](/assets/images/math/derivative_ce.png){: loading="lazy"}
...
![scale](/assets/images/math/scale.png){: loading="lazy"}
...
![relu](/assets/images/math/relu.png){: loading="lazy"}
...
![problem_with_Gd](/assets/images/math/problem_with_gd.png){: loading="lazy"}
![sgdbad](/assets/images/math/SGD_BAD.png){: loading="lazy"}
...
- When training neural networks, the classic fear is getting stuck in a local minimum, a small valley that isn't the lowest point. 
...
![adam](/assets/images/math/adam.png){: loading="lazy"}
...
![lr](/assets/images/math/lr.png){: loading="lazy"}
...
$$
\text{output}_{\text{fn}}
= f_{50}\!\left( f_{49}\!\left( \cdots f_2\!\left( f_1(\text{input}) \right) \cdots \right) \right)
$$
...
![res](/assets/images/math/resnet.png){: loading="lazy"}
...
![resnet](/assets/images/math/resnet_transformers.png){: loading="lazy"}
...
- All word embeddings of a document concatenated into a matrix (every row = embedding of different word)
  - What are word embeddings? Solves the problem of how to give text data to a Neural Network
    - What we want:
      ...
      - ![embeddings](/assets/images/math/embeddings.png){: loading="lazy"}
...
![encoder-decoder](/assets/images/math/encoder-decoder.png){: loading="lazy"}
...
![attention](/assets/images/math/attention.png){: loading="lazy"}
![attention_formula](/assets/images/math/attention_for.png){: loading="lazy"}

![howattnworks](/assets/images/math/how_attention_works.png){: loading="lazy"}
...
![causal](/assets/images/math/causal.png){: loading="lazy"}

<video autoplay loop muted playsinline style="max-width:100%">
  <source src="/assets/images/math/causal_mask.mp4" type="video/mp4">
</video>
...
```python
'''
We need positional encoding in Transformer models because their parallel processing mechanism (self-attention) doesn't inherently understand word order, which matters a lot for meaning in language
...
![dot_prod](/assets/images/math/dot_product.png){: loading="lazy"}
...
![mm](/assets/images/math/matrixmul.png){: loading="lazy"}
